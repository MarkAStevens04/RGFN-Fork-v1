#!/bin/bash
#SBATCH --job-name=fr_scent_drd2_recipes
...
# SCENT DRD2 fixed-reward re-run WITH synthesis-recipe logging (Logs/027, LSD-Flow exact cost).
...
#
# Supersedes the recipe-less 5000-iter run (2026-07-07_17-16-37) as the SCENT sEH anchor for the
# LSD-Flow analysis. Guidance sidecar (guidance_models.pt) is emitted as usual (P_B recoverable).
#
# Submit with:  sbatch experiments/fixed_reward/scent_seh/experiments/fixed_reward/scent_drd2/submit_fixed_scent_drd2_recipes.sh

...
Entry 006 (research/preprocessing/full_comparison/) ranked the six oracle
...
DOCK6TD3 = ROOT / "research" / "preprocessing" / "docking_6td3"
KNOWN_CSV = DOCK6TD3 / "known_results.csv"
DECOY_CSV = DOCK6TD3 / "decoy_cdk_results.csv"

# Shared palette (matches full_comparison/ where they overlap).
